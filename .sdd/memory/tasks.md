...
**Critérios BDD**:
- [x] **Cenário**: Portaria força a devolução de chave retirada normalmente
...
- [x] **Cenário**: Justificativa é obrigatória na devolução forçada
...
- [x] **Cenário**: Apenas a portaria força a devolução
...
- [x] **Cenário** (regressão): devolução forçada de chave atribuída via bypass continua funcionando
...
**Critérios BDD**:
- [x] **Cenário**: Botão "Devolver" no card mobile
...
- [x] **Cenário**: Devolução forçada com justificativa pela portaria no mobile
...
- [x] **Cenário**: Estados claros no card
...
- [x] **Cenário** (e2e): porteiro força devolução de chave em uso pelo mobile
