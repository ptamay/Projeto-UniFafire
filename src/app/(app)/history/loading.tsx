...
// TASK-096 (ADR-018) — boundary de carregamento de `/history`.
//
...
//
// Variante `tabela` porque movimentacoes em tabela, a tela mais pesada — o esqueleto imita a forma da pagina para
// o olho ja se posicionar, e o conteudo nao deslocar nada quando chegar.
export default function Loading() {
    return <EsqueletoDePagina titulo="Histórico" variante="tabela" />;
}
