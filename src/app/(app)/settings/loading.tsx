...
// TASK-096 (ADR-018) — boundary de carregamento de `/settings`.
//
...
//
// Variante `cards` porque tres cartoes lado a lado — o esqueleto imita a forma da pagina para
// o olho ja se posicionar, e o conteudo nao deslocar nada quando chegar.
export default function Loading() {
    return <EsqueletoDePagina titulo="Configurações" variante="cards" />;
}
