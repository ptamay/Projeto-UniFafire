            ...
            <main className="main-content animate-fade">
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 360px), 1fr))', gap: '1.5rem' }}>
                    ...
                    <div className="card">
                        <h2 style={{ fontSize: 'var(--fs-3)', fontWeight: 700, marginBottom: '1.25rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--text-muted)" strokeWidth="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
                            Sistema e Segurança
                        </h2>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                            ...
                            <div>
                                <button className="btn btn-principal" onClick={saveSettings} disabled={savingSettings}>
                    ...
                    <div className="card">
                        <h2 style={{ fontSize: 'var(--fs-3)', fontWeight: 700, marginBottom: '1.25rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--text-muted)" strokeWidth="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
                            Backup
                        </h2>
                            ...
                            return (
                                <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', gap: '0.75rem', marginTop: '1rem' }}>
                                    <div style={{ minWidth: 0 }}>
                                        ...
                                        {!ultimo.succeeded && (
                                            <div style={{ fontSize: 'var(--fs-2)', color: 'var(--alerta-fg)', overflowWrap: 'anywhere' }}>
                                                {ultimo.error || 'falhou sem mensagem registrada'}
                                            </div>
                                        )}
                                    </div>
                                    <span style={{ flexShrink: 0, fontSize: 'var(--fs-2)', fontWeight: 700, color: ultimo.succeeded ? 'var(--livre-fg)' : 'var(--alerta-fg)' }}>
                        ...
                        <div style={{ marginTop: '0.75rem' }}>
                            <button className="btn btn-principal" onClick={salvarAgenda} disabled={salvandoAgenda}>
                ...
                <section
                    ...
                    style={{
                        ...
                        border: '1px solid var(--alerta-fg)', borderRadius: 'var(--radius-md)',
                        background: 'var(--alerta-bg)',
                    }}
                >
                    <h2 id="zona-perigo" style={{ fontSize: 'var(--fs-3)', fontWeight: 700, color: 'var(--alerta-fg)', display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.75rem' }}>
                    ...
                    {restauracao?.configurado && (
                        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '1rem', alignItems: 'flex-end', justifyContent: 'space-between', paddingBottom: '1rem', marginBottom: '1rem', borderBottom: '1px solid var(--border)' }}>
                            ...
                            <button className="btn btn-perigo" style={{ flexShrink: 0 }}
