...
// TASK-096 (ADR-018) — boundary de carregamento de `/confirm`.
//
...
//
// Variante `tabela` porque lista de pendencias — o esqueleto imita a forma da pagina para
// o olho ja se posicionar, e o conteudo nao deslocar nada quando chegar.
export default function Loading() {
    return <EsqueletoDePagina titulo="Confirmações" variante="tabela" />;
}
